...
//	***
	...
	vHisto1D[phi_rapidity]->Draw("colz");
	vCanvas[phi_kinematics]->cd(2)->SetLogz();
	vHisto1D[phi_pseudorapidity]->Draw("colz");
	vCanvas[phi_kinematics]->cd(3)->SetLogz();
	vHisto1D[phi_pt]->Draw("colz");
	vCanvas[phi_kinematics]->cd(4)->SetLogz();
	vHisto1D[phi_rapidity_selected]->Draw("colz");
	vCanvas[phi_kinematics]->cd(5)->SetLogz();
	vHisto1D[phi_pseudorapidity_selected]->Draw("colz");
	vCanvas[phi_kinematics]->cd(6)->SetLogz();
	vHisto1D[phi_pt_selected]->Draw("colz");
//	***
	vCanvas[pt_kinematics]->cd(1)->SetLogz();
	vHisto1D[pt_rapidity]->Draw("colz");
	vCanvas[pt_kinematics]->cd(2)->SetLogz();
	vHisto1D[pt_pseudorapidity]->Draw("colz");
	vCanvas[pt_kinematics]->cd(3)->SetLogz();
	vHisto1D[rapidity_pseudorapidity]->Draw("colz");
	vCanvas[pt_kinematics]->cd(4)->SetLogz();
	vHisto1D[pt_rapidity_selected]->Draw("colz");
	vCanvas[pt_kinematics]->cd(5)->SetLogz();
	vHisto1D[pt_pseudorapidity_selected]->Draw("colz");
	vCanvas[pt_kinematics]->cd(6)->SetLogz();
	vHisto1D[rapidity_pseudorapidity_selected]->Draw("colz");
//	***
	vCanvas[mass_qa]->cd(1);
	vHisto1D[dEdXTOF_p]->Draw("colz");
	vCanvas[mass_qa]->cd(2);
	vHisto1D[dEdXMDC_p]->Draw("colz");
	vCanvas[mass_qa]->cd(3);
	vHisto1D[beta_p]->Draw("colz");
	vCanvas[mass_qa]->cd(4);
	vHisto1D[dEdXTOF_p_selected]->Draw("colz");
	vCanvas[mass_qa]->cd(5);
	vHisto1D[dEdXMDC_p_selected]->Draw("colz");
	vCanvas[mass_qa]->cd(6);
	vHisto1D[beta_p_selected]->Draw("colz");
// ***
	for(int i=0; i<NumCanvases; i++)
    {
