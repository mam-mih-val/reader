...
void Flow3SE::Estimate()
{
	...
	int centrality = fCentrality->GetCentralityClass();
...
void Flow3SE::SavePictures(TString sFileName)
{
	...
	for(int i=1; i<4; i++)
	{
		hRapidityOnX.at(i)->SetLineColor(0);
		hRapidityOnX.at(i)->SetMarkerColor(i+1);
		hRapidityOnX.at(i)->SetMarkerStyle(20+i);
		hRapidityOnX.at(i)->SetMarkerSize(4);
		hRapidityOnX.at(i)->SetLineWidth(0);

		hRapidityOnY.at(i)->SetLineColor(0);
		hRapidityOnY.at(i)->SetMarkerColor(i+1);
		hRapidityOnY.at(i)->SetMarkerStyle(20+i);
		hRapidityOnY.at(i)->SetMarkerSize(4);
		hRapidityOnY.at(i)->SetLineWidth(0);
		
		hPtOnX.at(i)->SetLineColor(0);
		hPtOnX.at(i)->SetMarkerColor(i+1);
		hPtOnX.at(i)->SetMarkerStyle(20+i);
		hPtOnX.at(i)->SetMarkerSize(4);
		hPtOnX.at(i)->SetLineWidth(0);
		
		hPtOnY.at(i)->SetMarkerColor(i+1);
		hPtOnY.at(i)->SetLineColor(0);
		hPtOnY.at(i)->SetMarkerStyle(20+i);
		hPtOnY.at(i)->SetMarkerSize(4);
		hPtOnY.at(i)->SetLineWidth(0);
	...
	canvas.push_back( new TCanvas( "canv", "", 4000, 2500 ) );
	// canvas.back()->cd();
